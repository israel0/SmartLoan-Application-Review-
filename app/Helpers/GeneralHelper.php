...
class GeneralHelper
{
    ...
    public function Sendpopemail($user, $message)
    {
        $email = "seyeakinsola@gmail.com";
        $body = Sentinel::getUser()->first_name . ' ' . Sentinel::getUser()->last_name. " ". $message . $user;
        Mail::to($email)->send(new Notification($body));
