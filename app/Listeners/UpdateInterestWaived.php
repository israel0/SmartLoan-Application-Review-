...
class UpdateInterestWaived
{
    ...
    public function handle(InterestWaived $event)
    {
        ...
        foreach (LoanTransaction::where('loan_id', $loan_transaction->loan_id)->where('transaction_type',
            ...
            // mail("tjmugova@smartwork.co.zw", "Test", $payments, "From: Test<test@test.com>");
           // break;
        }
        //mail("tjmugova@smartwork.co.zw", "Test", print_r($covered_schedules, true), "From: Test<test@test.com>");
    }
