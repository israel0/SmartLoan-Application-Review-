...
//                'chart_liability', 'chart_equity', 'chart_assets', 'chart', 'charges'));
        return view('loan_product.create',   compact('loan_disbursed_by', 'loan_overdue_penalties', 'chart_expenses', 'chart_income',
            'chart_liability', 'chart_equity', 'chart_assets', 'chart', 'charges'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (empty($request->repayment_order)) {
            return redirect('loan/loan_product/data')->with('warning','Invalid Repayment Order Entry');
        } else {
        ...
        return redirect('loan/loan_product/data')->with("success" , trans('general.successfully_saved'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (empty($request->repayment_order)) {
            return redirect()->back()->with("warning" , trans("general.repayment_order_error"));
        } else {
            $loan_product->repayment_order = serialize($request->repayment_order);
        }
        $loan_product->minimum_principal = $request->minimum_principal;
    ...
    public function delete($id)
    {
        ...
        return redirect('loan/loan_product/data')->with("success" , trans('general.successfully_deleted'));
    }
