...
class LoanRepaymentMethodController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('loan/loan_repayment_method/data')->with("success" , trans('general.successfully_saved'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('loan/loan_repayment_method/data')->with("success" , trans('general.successfully_deleted'));
    }
