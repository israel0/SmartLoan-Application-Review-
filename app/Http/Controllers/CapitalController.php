...
class CapitalController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (isset($request->return_url)) {
            return redirect($request->return_url)->with("success" , trans('general.successfully_saved') );
        }
        return redirect('capital/data')->with("success" , trans('general.successfully_saved') );
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('capital/data')->with("success" , trans('general.successfully_deleted'));
    }
