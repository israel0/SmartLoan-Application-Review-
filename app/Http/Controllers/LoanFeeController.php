...
class LoanFeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $loan_fee->save();
        return redirect('loan/loan_fee/data')->with("success" , trans('general.successfully_saved'));
    }
    ...
    {
        LoanFee::destroy($id);
        return redirect('loan/loan_fee/data')->with("success" , trans('general.successfully_deleted'));
    }
