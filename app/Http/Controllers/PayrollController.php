...
class PayrollController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('payroll/data')->with("success" , trans('general.successfully_saved'));
    }
    ...
    public function addTemplateRow(Request $request, $id)
    {
        ...
        $meta->save();
        return redirect('payroll/template/' . $id . '/edit')->with("success" , trans('general.successfully_saved'));
    }
    ...
    public function updateTemplate(Request $request, $id)
    {
        ...
        return redirect('payroll/template')->with("success" , trans('general.successfully_saved'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('payroll/data')->with("success" , trans('general.successfully_deleted'));
    }
