...
class UpdateController extends Controller
{
    ...
    public function install()
    {
        if (file_exists(storage_path() . "/updates/update.zip")) {
            ...
            if ($zip->open(storage_path() . "/updates/update.zip") === TRUE) {
                ...
                return redirect('update/finish')->with("warning" , trans('general.update_successful'));
               // 
            } else {
                return redirect()->back()->with("success" , trans('general.update_file_does_not_exist'));
                // ->with("success" , trans('general.successfully_saved'))
            }
        } else {
            return redirect()->back()->with("success" , trans('general.update_file_does_not_exist'));
        }
    ...
    public function fix()
    {
        ...
        return redirect('dashboard')->with("success" , "Successfully fixed " . $count . " records");
    }
    ...
    public function set_default_branch()
    {
        ...
        return redirect('dashboard')->with("success" , "Successfully fixed 1 records");
    }

    public function update_2_0()
    {

        return redirect('update_2_0_1')->with("success" , "Starting  the update now:Step 1");
    }
    public function update_2_0_1()
    {
        ...
        return redirect('update_2_0_2')->with("success" , "Update in progress:Step 2");
    }
    public function update_2_0_2()
    {
        ...
        return redirect('update_2_0_3')->with("success" , "Update in progress:Step 3");
    }
    public function update_2_0_3()
    {
        ...
        return redirect('dashboard')->with("success" , "Successfully updated  records");
    }
}
