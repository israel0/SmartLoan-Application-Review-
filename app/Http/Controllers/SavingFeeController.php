...
class SavingFeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $savings_fee->save();
        return redirect('saving/savings_fee/data')->with("success" , trans('general.successfully_saved'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('saving/savings_fee/data')->with("success" , trans('general.successfully_deleted'));
    }
