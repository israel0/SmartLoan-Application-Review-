...
class AssetController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($request->file('files'))) {
            ...
            foreach ($request->file('files') as $key) {
                ...
                if ($validator->fails()) {
                    return redirect()->back()->withInput()->with("warning" , trans('general.validation_error'));
                } else {
        ...
        return redirect('asset/data')->with("success" , trans('general.validation_error'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('asset/data')->with("warning" , trans('general.successfully_saved') );
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('asset/data')->with("success" , trans('general.successfully_deleted'));
    }
    ...
    public function storeType(Request $request)
    {
        ...
        $type->save();
        return redirect('asset/type/data')->with("success" ,trans('general.successfully_saved') );
    }
    ...
    public function deleteType($id)
    {
        ...
        return redirect('asset/type/data')->with("success" , trans('general.successfully_deleted'));
    }
