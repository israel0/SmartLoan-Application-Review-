...
class SavingTransactionController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('saving/' . $savings_transaction->savings_id . '/show')->with("success" , trans('general.successfully_saved'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->back()->with("success" , trans('general.successfully_deleted'));
    }
//    print repayment
