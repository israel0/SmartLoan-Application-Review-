...
class SavingProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('saving/savings_product/data')->with("success" , trans('general.successfully_saved'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('saving/savings_product/data')->with("success" , trans('general.successfully_deleted'));
    }
