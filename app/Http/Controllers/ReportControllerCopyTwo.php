...
use PDF;use Maatwebsite\Excel\Excel as ExcelExcel;
...
class ReportController extends Controller
{
    ...
    public function trial_balance_excel(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            Excel::create( function ($excel) use ($data) {
                $excel->sheet('Sheet', function ($sheet) use ($data) {
                    $sheet->fromArray($data, null, 'A1', false, false);
                    $sheet->mergeCells('A1:D1');
                });
            }, 'general.trial_balance.xls', ExcelExcel::XLSX);                       
        }
    }
...
if (!empty($start_date)) {
    ...
    }, trans_choice('general.trial_balance', 1) . ' : ' . $request->end_date."csv");
      }  
    }
    ...
    public function income_statement_excel(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            }, 'general.income.xls', ExcelExcel::XLSX);
        }
    }
    ...
    public function balance_sheet_excel(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            array_push($data, [
                ...
                }, 'general.balance.xls', ExcelExcel::XLSX);
        }
    }
    ...
    public function missed_repayments_pdf(Request $request)
    {
        ...
        $pdf = PDF::loadView('loan_report.missed_repayments_pdf', compact('start_date',
            'end_date', 'due_items', 'paid_items'));
        return $pdf->download(trans_choice('general.missed', 1) . ' ' . trans_choice('general.repayment',
                2) . ".pdf");
    }
    ...
    public function missed_repayments_excel(Request $request)
    {
        ...
        $data = [];
        array_push($data, [
            trans_choice('general.missed', 1) . ' ' . trans_choice('general.repayment',
                2)
        ]);
        array_push($data, [
            "",
        ...
        },  'general.missed.xls', ExcelExcel::XLSX);
    }
    ...
    public function missed_repayments_csv(Request $request)
    {
        ...
        }, trans_choice('general.missed', 1) . ' : ' . $request->end_date."csv");
    }
    ...
    public function repayments_report_excel(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            }, 'general.repayment.xls' , ExcelExcel::XLSX);
        }
    ...
    public function repayments_report_csv(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            }, trans_choice('general.repayment', 2) . ' : ' . $request->end_date."csv");
        }
        ...
        if (!empty($start_date)) {
            ...
            array_push($data, [
                ...
                trans_choice('general.maturity', 1) . " " . trans_choice('general.date',
                    1),
                trans_choice('general.missed', 1) . " " . trans_choice('general.amount',
                    1),
            ...
            foreach ($ldata as $key) {
                ...
                if (!empty($schedule)) {
                    ...
                    $loan_paid_items = \App\Helpers\GeneralHelper::loan_paid_items($key->id,
                        $key->release_date, $schedule->due_date);
                    $missed = $schedule->principal + $schedule->interest + $schedule->fees + $schedule->panalty;
            ...
            }, 'general.collection.xls' , ExcelExcel::XLSX);
        }
    ...
    public function collection_sheet_csv(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            }, trans_choice('general.collection', 1) . ' : ' . $request->end_date."csv");
        }
    ...
    public function arrears_report_excel(Request $request)
    {
        ...
        if (!empty($end_date)) {
            ...
            }, 'general.arrears.xls' , ExcelExcel::XLSX);
        }
    ...
    public function arrears_report_csv(Request $request)
    {
        ...
        if (!empty($end_date)) {
            ...
            }, trans_choice('general.arrears', 1) . ' : ' . $request->end_date."csv");
        }
    ...
    public function disbursed_loans_excel(Request $request)
    {
        ...
        if (!empty($end_date)) {
            ...
            }, 'general.disbursed.xls', ExcelExcel::XLSX);
        }
    ...
    public function disbursed_loans_csv(Request $request)
    {
        ...
        if (!empty($end_date)) {
            ...
            }, trans_choice('general.disbursed', 1) . ' : ' . $request->end_date."csv");
        }
    ...
    public function provisioning_excel(Request $request)
    {
        ...
        if (!empty($end_date)) {
            ...
            },  'general.provisioning.xls', ExcelExcel::XLSX);
        }
    ...
    public function provisioning_csv(Request $request)
    {
        ...
        if (!empty($end_date)) {
            ...
            }, trans_choice('general.provisioning', 1) . ' : ' . $request->end_date."csv");
        }
    ...
    public function products_summary_excel(Request $request)
    {
        ...
        if (!empty($end_date)) {
            ...
            },  'general.product.xls' , ExcelExcel::XLSX);
        }
    ...
    public function products_summary_csv(Request $request)
    {
        ...
        if (!empty($end_date)) {
            ...
            }, trans_choice('general.product', 2) . ' : ' . $request->end_date."csv");
        }
    ...
    public function general_report(Request $request)
    {
        ...
        return view('company_report.general_report',
            compact('loan_product_data', 'monthly_net_income_data', 'monthly_borrower_data', 'monthly_repayments_data',
                'monthly_actual_missed_data', 'monthly_disbursed_loans_data','start_date','end_date'));
    }
    ...
    public function savings_transactions_excel(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            }, 'general.saving.xls' , ExcelExcel::XLSX);
        }
    ...
    public function savings_transactions_csv(Request $request)
    {
        ...
        if (!empty($start_date)) {
            ...
            }, trans_choice('general.saving', 2) . ' : ' . $request->end_date."csv");
        }
