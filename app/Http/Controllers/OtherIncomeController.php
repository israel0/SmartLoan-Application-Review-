...
class OtherIncomeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('other_income/data')->with("success" , trans('general.successfully_saved'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('other_income/data')->with("success" , trans('general.successfully_deleted'));
    }
    ...
    public function storeType(Request $request)
    {
        ...
        $type->save();
        return redirect('other_income/type/data')->with("success" , trans('general.successfully_saved'));
    }
    ...
    public function deleteType($id)
    {
        ...
        return redirect('other_income/type/data')->with("success" , trans('general.successfully_deleted'));
    }
}
