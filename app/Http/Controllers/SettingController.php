...
class SettingController extends Controller
{
    ...
    public function updateSystem()
    {
        ...
        return redirect('setting/data')->with("success" , "Settings Successfully Updated");
    }
    ...
    { 
         ...
         Setting::where('setting_key', 'betasms_email')->update(['setting_value' => $request->email]);
         Setting::where('setting_key', 'betasms_pass')->update(['setting_value' => $request->password]);
         return redirect("communication/sms")->with("success" , "Credentials Updated Successfully");
    ...
    public function update(Request $request)
    {
        ...
        return redirect('setting/data')->with("success" , trans_choice('general.successfully_saved' , 1));
    }
