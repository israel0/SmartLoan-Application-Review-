...
class BorrowerController extends Controller
{
    ...
    public function create()
    {
        ...
        $existingUniqueNumber = Borrower::where('unique_number', $uniqueNumber)->count();
        if($existingUniqueNumber > 0) {
            $uniqueNumber = rand(1000000000, 9999999999);
            $existingUniqueNumber = Borrower::where('unique_number', $uniqueNumber)->count();
            if($existingUniqueNumber > 0) {
                $uniqueNumber = rand(1000000000, 9999999999);
        ...
        return view('borrower.create', compact('user', 'custom_fields','countries', 'uniqueNumber'));
    }
    ...
    public function store(Request $request)
    {
        ...
        GeneralHelper::sendpopemail($borrower->id , "Added Borrower with user id");
        GeneralHelper::audit_trail("Added borrower  with id:" . $borrower->id);
        return redirect('borrower/data')->with("success" , trans('general.successfully_saved'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('borrower/data')->with("success" , trans('general.successfully_deleted'));
    }
