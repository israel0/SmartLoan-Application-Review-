...
class ExpenseController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       return redirect('expense/data')->with("success" , trans('general.successfully_saved'));
    }
    ...
    public function delete($id)
    {
       ...
       return redirect('expense/data')->with("success" , trans('general.successfully_deleted'));
    }
    ...
    public function storeType(Request $request)
    {
        ...
        $type->save();
       return redirect('expense/type/data')->with("success" , trans('general.successfully_saved'));
    }
    ...
    public function deleteType($id)
    {
       ...
       return redirect('expense/type/data')->with("success" , trans('general.successfully_deleted'));
    }
