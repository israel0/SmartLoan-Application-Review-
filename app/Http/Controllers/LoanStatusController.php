...
class LoanStatusController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $loan_status->save();
        return redirect('loan/loan_status/data')->with("success" , trans('general.successfully_saved'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('loan/loan_status/data')->with("success" , trans('general.successfully_deleted'));
    }
