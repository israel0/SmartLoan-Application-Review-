...
class SavingController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if (empty($savings_product)) {
             return redirect()->back()->with("success" , "No Savings product set. You must first set a savings product");
    ...
    public function store(Request $request)
    {
        ...
        GeneralHelper::sendpopemail($saving->id , "Added Saving with saving id");
        return redirect('saving/data')->with("success" , trans('general.successfully_saved'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('saving/data')->with("success" , trans('general.successfully_deleted'));
    }
    ...
    public function storeTransfer(Request $request, $saving)
    {
        ...
        if (GeneralHelper::savings_account_balance($saving->id) < $request->amount && $saving->savings_product->allow_overdraw == 0) {
            return redirect()->back()->with("warning" ,trans('general.withdrawal_more_than_balance'));
        ...
        return redirect('saving/' . $saving->id . '/show')->with("success" , trans('general.successfully_saved'));
    }
}
