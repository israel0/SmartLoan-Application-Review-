...
$(function() {
    ...
    $('.select-menu-color').select2({
        containerCssClass: 'bg-success-400',
        dropdownCssClass: 'bg-success-400'
    });
    ...
    $('.growl-launch').on('click', function () {
        $.jGrowl('I am a well highlighted indigo notice..', { theme: 'bg-success-400', header: 'Well highlighted' });
    });
    ...
    $('[data-popup=popover-custom]').popover({
        template: '<div class="popover border-indigo"><div class="arrow"></div><h3 class="popover-title bg-success"></h3><div class="popover-content"></div></div>'
    });
