            ...
            <div class="heading-elements">
                @if(Sentinel::hasAccess('borrowers.create'))
                    <a href="{{ url('borrower/create') }}"
                       class="btn btn-warning btn-sm">{{trans_choice('general.add',1)}} {{trans_choice('general.borrower',1)}}</a>
                @endif
            </div>
        </div>
                            ...
                            <td> 
                             @if($key->photo == NULL)
                               <img src="{{ asset('assets/dist/img/avatar5.png') }}"
                                     class="img-circle img-responsive" alt="borrower-photo" width="70"></a>
                             @else
                                    <img src="{{ url('/') }}/uploads/{{ $key->photo }}"
                                     class="img-circle img-responsive" alt="borrower-photo" width="70"></a>
                             @endif
                            </td>
