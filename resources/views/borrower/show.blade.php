        ...
        <div class="sidebar sidebar-default sidebar-separate">
            <div class="sidebar-content">
                ...
                <div class="content-group">
                    <div class="panel-body bg-success-400 border-radius-top text-center"
                        ...
                        <div class="content-group-sm">
                            ...
                            @if($borrower->gender=="Male")
                                <span class="display-block">{{trans_choice('general.male',1)}}
                                    , {{ date_diff(date_create($borrower->dob), date_create('now'))->y }} {{trans_choice('general.year',2)}}</span>
                            @endif
                        ...
                        <ul class="list-inline list-inline-condensed no-margin-bottom">
                            <li><a href="{{url('communication/email/create?borrower_id='.$borrower->id)}}"
                                   class="btn bg-success btn-rounded btn-icon" data-toggle="tooltip"
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="heading-elements">
                                <div class="input-group-btn">
                                    <button type="button" class="btn btn-warning dropdown-toggle margin"
