...
@section('title')
    {{trans_choice('general.missed',1)}} {{trans_choice('general.repayment',2)}}
@endsection
@section('content')
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li>
                                    <a href="{{url('report/loan_report/missed_repayments/pdf?start_date='.$start_date.'&end_date='.$end_date)}}"
                                       target="_blank"><i
                                                class="icon-file-pdf"></i> {{trans_choice('general.download',1)}} {{trans_choice('general.to',1)}} {{trans_choice('general.pdf',1)}}
                                    </a></li>
                                <li>
                                    <a href="{{url('report/loan_report/missed_repayments/excel?start_date='.$start_date.'&end_date='.$end_date)}}"
                                       target="_blank"><i
                                                class="icon-file-excel"></i> {{trans_choice('general.download',1)}} {{trans_choice('general.to',1)}} {{trans_choice('general.excel',1)}}
                                    </a></li>
                                <li>
                                    <a href="{{url('report/loan_report/missed_repayments/csv?start_date='.$start_date.'&end_date='.$end_date)}}"
                                       target="_blank"><i
    ...
    <div class="panel panel-white">
        <div class="panel-body table-responsive no-padding">
            ...
            <table class="table table-bordered table-condensed table-hover">
                ...
                <tbody>
                <tr>
                    <td><b>{{trans_choice('general.missed',1)}}</b></td>
