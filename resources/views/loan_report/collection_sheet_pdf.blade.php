...
<div>
    ...
    <table class="">
        <caption>
            {{trans_choice('general.current_loan',1)}} 
            @if(!empty($start_date))
        ...
        <tr class="">
            ...
            <th>{{trans_choice('general.missed',1)}} {{trans_choice('general.repayment',1)}} {{trans_choice('general.date',1)}}</th>
            <th>{{trans_choice('general.maturity',1)}} {{trans_choice('general.date',1)}}</th>
            <th>{{trans_choice('general.missed',1)}}  {{trans_choice('general.amount',1)}}</th>
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td><b>{{number_format($total_missed,2)}}</b></td>
