...
@section('title')
    {{trans_choice('general.past_maturity',1)}} {{trans_choice('general.loan',2)}}
@endsection
@section('content')
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li>
                                    <a href="{{url('report/loan_report/past_maturity_loans/pdf?start_date='.$start_date.'&end_date='.$end_date."&loan_product_id=".$user_id)}}"
                                       target="_blank"><i
                                                class="icon-file-pdf"></i> {{trans_choice('general.download',1)}} {{trans_choice('general.to',1)}} {{trans_choice('general.pdf',1)}}
                                    </a></li>
                                <li>
                                    <a href="{{url('report/loan_report/past_maturity_loans/excel?start_date='.$start_date.'&end_date='.$end_date."&loan_product_id=".$user_id)}}"
                                       target="_blank"><i
                                                class="icon-file-excel"></i> {{trans_choice('general.download',1)}} {{trans_choice('general.to',1)}} {{trans_choice('general.excel',1)}}
                                    </a></li>
                                <li>
                                    <a href="{{url('report/loan_report/past_maturity_loans/csv?start_date='.$start_date.'&end_date='.$end_date."&loan_product_id=".$user_id)}}"
                                       target="_blank"><i
            ...
            <div class="panel-body table-responsive no-padding">
                ...
                <table class="table table-bordered table-condensed table-hover">
                    ...
                    <tr class="bg-green">
                        ...
                        <th>{{trans_choice('general.past_maturity',1)}}</th>
