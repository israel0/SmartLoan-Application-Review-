                ...
                <div style="background-color: rgba(255, 255, 255, 0.8); border-radius: 8px; margin: 40px 0 0 5px; padding: 15px; width: 100%;">
                    ...
                    @if(\App\Models\Setting::where('setting_key', 'allow_client_login')->first()->setting_value == 1)
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <button type="submit"
                                        class="btn btn-warning btn-block btn-flat">{{ trans('general.login') }}</button>
                            </div>
                            <!-- /.col -->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-8">
                                <div class="">
                                    <a href="javascript:;" class="btn btn-warning  btn-flat" id="back-btn"><i
                            ...
                            <div class="col-xs-4">
                                <button type="submit"
                                        class="btn btn-warning btn-block btn-flat">{{ trans('general.reset') }}</button>
                            </div>
                            <!-- /.col -->
                        </div>
                        {!! Form::close() !!}
                        ...
                        <div class="row">
                            <div class="col-xs-8">
                                <div class="">
                                    <a href="javascript:;" class="btn btn-warning  btn-flat" id="register-back-btn"><i
                                                class="fa fa-backward"></i> {{ trans('general.back') }}</a>
                                </div>
                            </div>
                            <!-- /.col -->
                            <div class="col-xs-4">
                                <button type="submit"
                                        class="btn btn-warning btn-block btn-flat">{{ trans('general.register') }}</button>
                            </div>
                            <!-- /.col -->
                        </div>
                        {!! Form::close() !!}
