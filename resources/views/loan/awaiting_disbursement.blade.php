            ...
            <div class="heading-elements">
                @if(Sentinel::hasAccess('loans.create'))
                    <a href="{{ url('loan/create') }}"
                       class="btn btn-warning btn-sm">{{trans_choice('general.add',1)}} {{trans_choice('general.loan',1)}}</a>
                @endif
            </div>
        </div>
        <div class="panel-body table-responsive">
            <table id="data-table" class="table table-bordered table-striped table-condensed table-hover">
                ...
                <tr style="background-color: #D1F9FF">
                    ...
                    <th>{{trans_choice('general.missed',1)}} {{trans_choice('general.disbursement',1)}} {{trans_choice('general.date',1)}}</th>
