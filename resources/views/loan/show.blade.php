                        ...
                        <div class="col-md-3 form-horizontal">
                            <div class="form-group">
                                <label class="control-label col-md-4"><strong>{{trans_choice('general.age',1)}}
                                        :</strong></label>
                                <div class="col-md-8" style="padding-top: 9px;">
                                    <span>{{ date_diff(date_create($loan->borrower->dob), date_create('now'))->y }} {{trans_choice('general.year',2)}}</span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="input-group-btn">
                                            <button type="button" class="btn btn-warning dropdown-toggle m-10"
                                                    data-toggle="dropdown"
                                ...
                                <div class="tab_content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6"><h6>
                                                        <b>{{trans_choice('general.last',1)}} {{trans_choice('general.payment',1)}} {{trans_choice('general.missed',2)}}
                                                            :</b></h6></div>
                                                <div class="col-md-6">
                                                    <h6>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit"
                                                    class="btn btn-warning">{{trans_choice('general.save',1)}}</button>
                                ...
                                <div class="col-sm-4 pull-right">
                                    <div class="btn-group-horizontal">
                                        ...
                                        @if(Sentinel::hasAccess('loans.delete'))
                                            <a type="button" class="btn btn-warning m-10 deleteLoan"
                        ...
                        <div class="tab-pane" id="loan_guarantors">
                            <div class="btn-group-horizontal">
                                @if(Sentinel::hasAccess('loans.guarantor.create'))
                                    <a type="button" class="btn btn-warning m-10" data-toggle="modal"
    ...
    <div class="modal fade" id="approveLoan">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-warning">{{trans_choice('general.save',1)}}</button>
                    <button type="button" class="btn default"
                            data-dismiss="modal">{{trans_choice('general.close',1)}}</button>
                </div>
                {!! Form::close() !!}
