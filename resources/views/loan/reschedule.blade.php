...
@section('content')
    <div class="panel panel-white">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                {!! Form::label('release_date',trans_choice('general.missed',1).' '.trans_choice('general.disbursement',1).' '.trans_choice('general.date',1)." *",array('class'=>'col-sm-3 control-label')) !!}
                <div class="col-sm-5">
        ...
        <div class="panel-footer">
            <button type="submit" class="btn btn-warning pull-right m-10">{{trans_choice('general.save',1)}}</button>
        </div>
        {!! Form::close() !!}
    </div>
    <!-- /.box -->
