            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <button type="button" class="btn btn-warning margin" data-toggle="modal" data-target="#addRow"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-warning">{{trans_choice('general.submit',1)}}</button>
