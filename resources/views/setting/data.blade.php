    ...
    <div class="panel panel-white">
        ...
        <div class="panel-heading">
            ...
            <div class="heading-elements">
                <button type="submit" class="btn btn-warning">{{ trans('general.save') }}</button>
            </div>
        </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane" id="general">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select('company_country',$countries,\App\Models\Setting::where('setting_key','company_country')->first()->setting_value,array('class'=>'form-control select2','placeholder'=>'','required'=>'required')) !!}
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="tab-pane" id="update">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <button class="btn btn-warning btn-sm" type="button" id="checkUpdate">Check Version
                                </button>
                                <br>
        ...
        <div class="panel-footer">
            <button type="submit" class="btn btn-warning pull-right">{{ trans('general.save') }}</button>
        </div>
        {!! Form::close() !!}
    </div>
    <!-- /.box -->
