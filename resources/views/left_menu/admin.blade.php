        ...
        <div class="sidebar-user-material">
            <div class="category-content">
                <div class="sidebar-user-material-menu">
                    <a href="#user-nav" data-toggle="collapse"><span> Welcome Back ! , {{ Sentinel::getUser()->first_name }} </span> <i class="caret"></i></a>
                </div>
            </div>
        ...
        <div class="sidebar-category sidebar-category-visible">
                ...
                <ul class="navigation navigation-main navigation-accordion">
                    <li class="@if(Request::is('dashboard')) active @endif">
                        <a href="{{ url('dashboard') }}">
                            <i class="fa fa-home"></i> <span>{{trans_choice('general.dashboard',1)}}</span>
                        </a>
                    </li>
            ...
            @if(Sentinel::hasAccess('communication'))
                ...
                @endif
                    ...
                    @endif
                    <li class="@if(Request::is('dashboard')) active @endif">
                        <a href="{{ url('release-note') }}">
                            <i class="fa fa-book"></i> <span>{{trans_choice('general.release_note',1)}}</span>
                        </a>
                    </li>
                    <li><a href="#"><i class="fa fa-wrench"> <b><i>COMING SOON</i></b></i></a></li>
