    ...
    <div class="panel panel-white">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                @if(!$chart_assets)
                    <div class="col-sm-2">
                        <a href="{{ url('/chart_of_account/create') }}" class="btn btn-warning btn-sm"><i class="fa fa-plus"></i></a>
                    </div>
                @endif
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                @if(App\Models\Charge::where('product', 'savings')->where('active', 1)->count() == 0)
                    <div class="col-sm-2">
                        <a href="{{ url('/charge/create') }}" class="btn btn-warning btn-sm"><i class="fa fa-plus"></i></a>
                    </div>
                @endif
                <div class="col-sm-1">
                    <button type="button" id="chargesAdd"
                            class="btn btn-warning pull-right">{{trans_choice('general.add',1)}}</button>
                </div>
            </div>
